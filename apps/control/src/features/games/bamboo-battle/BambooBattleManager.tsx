...
export function BambooBattleManager({ config, patch, notify }: GameManagerProps) {
  ...
  return <>
    <GamePanel>
      <GamePanelTitle title="Luật & kiểm thử Bamboo Battle" hint="Các nút test sẽ tự kích hoạt Game 02 để Stage hiển thị đúng."/>
    ...
    <GamePanel>
      <GamePanelTitle title="Cấu hình Bamboo Battle" hint="Cài đặt chỉ thuộc Game 02."/>
