 ...
 */
/**
 * @brief ãƒ‘ãƒ©ãƒ¡ãƒ¼ã‚¿IDã®ãƒ‡ãƒ•ã‚©ãƒ«ãƒˆå€¤ã‚’ä¿æŒã™ã‚‹å®šæ•°<br>
 *         ãƒ‡ãƒ•ã‚©ãƒ«ãƒˆå€¤ã®ä»•æ§˜ã¯ä»¥ä¸‹ã®ãƒžãƒ‹ãƒ¥ã‚¢ãƒ«ã«åŸºã¥ã<br>
...
import * as $ from './cubismdefaultparameterid.js';
